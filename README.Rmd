...
+ __time:__ `visualize_time()`, `visualize_time_multi()`, `visualize_time_hh()`: 
...
+ __freqs:__ `compute_freqs()`, `compute_freqs_multi()`,
`visualize_bigrams_freqs_multi()`, `compute_freqs_multi_by2()`,
`visualize_freqs_multi_by2()`: 
...
Compute and visualize change in n-gram usage across documents.
+ __sents:__ `compute_sent_summary()`, `compute_sent_summary_multi()`
Compute sentiment scores for n-grams.
+ __xy:__ `compute_freqs_multi_by2()`, `visualize_freqs_multi_by2()`, 
`compute_logratios_multi_by2()`, `visualize_logratios_multi_by2()`,
`compute_sentratios_multi_by2()`, `visualize_sentratios_multi_by2()`,
...
`compute_freqs_multi_wide()`, `compute_logratios_multi_wide()`, `compute_sentratios_multi_wide()`
